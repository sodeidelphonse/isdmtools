...
This tutorial will assist you through preparing data and generating spatial folds — the essential first steps before fitting an Integrated Species Distribution Model (ISDM).
...
before it goes into an integrated modelling tool. You can access both 'train' and 'test' sets and their corresponding datasets as follows:
