...
```{r fold-plot, fig.width = 8, fig.height = 4, out.height= "100%", fig.align = "center"}
...
The advanced guide on [ISDM Evaluation Workflow](isdm-evaluation-workflow.html) covers model building with external tools, calculation of dataset-specific and composite scores, suitability analysis and mapping with `isdmtools`
