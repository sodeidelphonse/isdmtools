...
**S3 Methods**: The package includes `summary()`, `print()` and `plot()` methods for different classes to provide a concise summary and a clear visualization of spatial data partitions, folds diagnostics and evaluation metrics. Other methods are discussed in the package vignettes.
